  ...
  return (
    <CognosContext.Provider value={{
      ...
      <div className="flex h-screen bg-background text-foreground overflow-hidden">
        ...
        <main className="flex-1 flex flex-col overflow-hidden pb-[calc(env(safe-area-inset-bottom,12px)+76px)] md:pb-0" style={{ paddingTop: 'env(safe-area-inset-top, 12px)' }}>
          <Outlet />
        </main>
      </div>
